...
/*
*Finds the first equal sign in the provided string if it exists and returns appropriate index,
*otherwise errors and returns a value accordingly.
*Return Value:
*    - index of first equal sign, if it exits
*    - -1, if it doesn't
*/
int find_first_equal_char(char * user_string, int length){
